package multiwarehouse.ecommerce.kafka.consumer.config;

import multiwarehouse.ecommerce.kafka.config.data.KafkaConfigData;
import multiwarehouse.ecommerce.kafka.config.data.KafkaConsumerConfigData;
