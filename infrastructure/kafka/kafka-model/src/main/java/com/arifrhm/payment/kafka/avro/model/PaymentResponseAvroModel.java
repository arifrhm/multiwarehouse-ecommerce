...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.arifrhm.payment.kafka.avro.model.OrderStatus orderStatus;
   ...
   */
  public PaymentResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID orderId, java.time.Instant createdAt, com.arifrhm.payment.kafka.avro.model.OrderStatus orderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: orderStatus = (com.arifrhm.payment.kafka.avro.model.OrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.arifrhm.payment.kafka.avro.model.OrderStatus getOrderStatus() {
    return orderStatus;
  }
   ...
   * @param value the value to set.
   */
  public void setOrderStatus(com.arifrhm.payment.kafka.avro.model.OrderStatus value) {
   ...
   */
  public static com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder newBuilder() {
    return new com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder();
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder newBuilder(com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder();
    } else {
      return new com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder newBuilder(com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel other) {
    if (other == null) {
      return new com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder();
    } else {
      return new com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder setOrderStatus(com.arifrhm.payment.kafka.avro.model.OrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.arifrhm.payment.kafka.avro.model.PaymentResponseAvroModel.Builder clearOrderStatus() {
      orderStatus = null;
    ...
    public PaymentResponseAvroModel build() {
      try {
        ...
        record.orderStatus = fieldSetFlags()[4] ? this.orderStatus : (com.arifrhm.payment.kafka.avro.model.OrderStatus) defaultValue(fields()[4]);
        return record;
