package com.arifrhm.order.service.domain.mapper;
...
import com.arifrhm.order.service.domain.entity.*;
import com.arifrhm.order.service.domain.valueobject.StreetAddress;
...
public class OrderDataMapper {
    ...
    public List<com.arifrhm.order.service.domain.entity.OrderItem> orderItemsToOrderItemEntities(
            @NotNull List<com.arifrhm.order.service.domain.dto.create.OrderItem> orderItems) {
        return orderItems.stream()
                .map(orderItem ->
                        com.arifrhm.order.service.domain.entity.OrderItem.builder()
    ...
    public List<OrderResponse.OrderItemResponse> orderItemsToOrderItemResponse(List<com.arifrhm.order.service.domain.entity.OrderItem> orderItems) {
        return orderItems.stream()
