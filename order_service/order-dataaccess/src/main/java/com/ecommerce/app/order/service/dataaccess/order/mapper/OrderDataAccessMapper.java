package multiwarehouse.ecommerce.order.service.dataaccess.order.mapper;

import multiwarehouse.ecommerce.order.service.dataaccess.order.entity.OrderAddressEntity;
import multiwarehouse.ecommerce.order.service.dataaccess.order.entity.OrderEntity;
import multiwarehouse.ecommerce.order.service.dataaccess.order.entity.OrderItemEntity;
...
public class OrderDataAccessMapper {
    ...
    public Order orderEntityToOrder(OrderEntity orderEntity) {
        return Order.builder()
                ...
                .sellerId(new SellerId(orderEntity.getSellerId()))
