package com.arifrhm.product.service.messaging.listener.kafka;
...
import com.arifrhm.product.service.domain.ports.input.message.listener.user.UserServiceMessageListener;
import com.arifrhm.product.service.messaging.mapper.ProductMessagingDataMapper;
        ...
        implements KafkaConsumer<UserResponseAvroModel>
{
    ...
    @Override
    @KafkaListener(id = "${kafka-consumer-config.product-service-user-saved-consumer-group-id}",
